...
resolve_conflicts() {
    ...
    while IFS= read -r line; do
        ...
        # Separatore: da qui in poi è incoming, non va tenuto
...
echo "🚀 SUPERPOWERS ACTIVATED - Super Mucca Current Change Resolver"
echo "============================================================="
echo "📅 Data: $(date)"
echo "🎯 Obiettivo: Risolvere tutti i conflitti Git prendendo current changes (HEAD)"
echo ""
